...
export const notesApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    addNewNote: builder.mutation({
      ...
      invalidatesTags: [{ type: "Note", id: "LIST" }], //Cached list will get removed/ updated
    }),
...
//getSelectors creates these selectors and we renam them all aliases using destructuring
export const {
