...
export const usersApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getUsers: builder.query({
      ...
      // keepUnusedDataFor: 5, default:60 sec
    ...
    addNewUser: builder.mutation({
      ...
      invalidatesTags: [{ type: "User", id: "LIST" }], //cached list will get updated
    }),
...
//getSelectors creates these selectors and we rename them all aliases using destructuring
export const {
